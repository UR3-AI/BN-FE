...
import type { ProjectNotesRequest, ProjectNotesResponse } from "./useProjectNotesMutation.type";

const manageProjectNotes = async ({ projectId, noteNumber, action }: ProjectNotesRequest) => {
